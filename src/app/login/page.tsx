...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex items-center justify-center min-h-screen bg-cover bg-center" style={{ backgroundImage: "url('https://i.imgur.com/DRC0VBn.png')" }}>
      ...
      <div className="relative z-10 p-8 bg-white rounded-lg shadow-lg max-w-md w-full">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <button type="submit" className="w-full py-2 bg-red-500 text-white rounded-md hover:bg-red-700 transition duration-200">Login</button>
        </form>
      </div>
    </div>
  );
